...
export default function Footer() {
  return (
    <footer className="fixed -bottom-5 z-10 left-0 right-0 w-full bg-gradient-to-r from-purple-900 via-purple-800 to-pink-800 backdrop-blur-lg border-b border-t border-purple-500/20 shadow-2xl mt-12 h-[21vh] md:h-[13vh] lg:h-[20vh] xl:h-[21vh] 2xl:h-[17vh]">
